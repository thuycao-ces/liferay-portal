...
SearchContainer dlSearchContainer = new SearchContainer(liferayPortletRequest, null, null, SearchContainer.DEFAULT_CUR_PARAM, dlPortletInstanceSettings.getEntriesPerPage(), portletURL, null, null);
