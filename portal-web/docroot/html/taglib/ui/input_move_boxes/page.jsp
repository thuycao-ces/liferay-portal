...
<div class='taglib-move-boxes <%= cssClass %><%= StringPool.SPACE %><%= leftReorder ? "left-reorder" : StringPool.BLANK %><%= StringPool.SPACE %><%= rightReorder ? "right-reorder" : StringPool.BLANK %>' id='<%= randomNamespace + "input-move-boxes" %>'>
