...
<div class="<%= controlGroupCss %><%= StringPool.SPACE %><%= fieldCss %>" <%= AUIUtil.buildData(data) %>>
	<<%= showForLabel ? "label" : "span" %><%= StringPool.SPACE %><%= AUIUtil.buildLabel("wrapper", inlineField, showForLabel, name, disabled) %>>
